...
{
		CaptureMaskAudio = (1L <<  LFLiveCaptureType.CaptureAudio),
		CaptureMaskVideo = (1L << LFLiveCaptureType.CaptureVideo),
		InputMaskAudio = (1L << LFLiveCaptureType.InputAudio),
		InputMaskVideo = (1L << LFLiveCaptureType.InputVideo),
		MixMaskAudio = (1L << LFLiveCaptureType. MixAudio| CaptureMaskAudio),
    ...
    MixMaskAudioInputVideo = (MixMaskAudio | InputMaskVideo),
