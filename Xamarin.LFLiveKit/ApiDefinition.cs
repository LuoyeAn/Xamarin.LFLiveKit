...
namespace Xamarin.LFLiveKit
{
    ...
    interface LFLiveAudioConfiguration : INSCoding, INSCopying
    {
        ...
        // @property (assign, nonatomic) BOOL echoCancellation;
    ...
    interface LFLiveSessionDelegate
    {
        ...
        // @optional -(void)liveSession:(LFLiveSession * _Nullable)session audioDataBeforeMixing:(NSData * _Nullable)audioData;
        [Export("liveSession:audioDataBeforeMixing:")]
        void AudioDataBeforeMixing([NullAllowed] LFLiveSession session, [NullAllowed] NSData audioData);
    }
    ...
    interface LFLiveSession
    {
        ...
        // @property (readonly, copy, nonatomic) NSString * _Nullable currentColorFilterName;
        [NullAllowed, Export("currentColorFilterName")]
        string CurrentColorFilterName { get; }

        // @property (assign, nonatomic) BOOL mirrorOutput;
        [Export("mirrorOutput")]
        bool MirrorOutput { get; set; }

        // @property (nonatomic, strong) NSURL * _Nullable audioPath;
        [NullAllowed, Export("audioPath", ArgumentSemantic.Strong)]
        NSUrl AudioPath { get; set; }
        ...
        [Export("pushVideo:")]
        unsafe void PushVideo([NullAllowed] CVPixelBuffer pixelBuffer);
        ...
        [Export("previousColorFilter")]
        void PreviousColorFilter();

        // -(void)nextColorFilter;
        [Export("nextColorFilter")]
        void NextColorFilter();
    }
